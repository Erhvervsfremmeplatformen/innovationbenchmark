      ...
      },
      {
        ...
        cardBody: [
          ...
          },
          {
            _key: '8fd705c319f8',
            _type: 'block',
            children: [{ _key: '72814270b8b2', _type: 'span', marks: [], text: 'Inspiration til diskussion af innovationsmulighederne hos jer.' }],
            level: 1,
            listItem: 'bullet',
            markDefs: [],
            style: 'normal'
  ...
  result: [
    {
      ...
      text: [
        ...
        },
        {
          ...
          _type: 'block',
          children: [
            { _key: 'b97d9365aab30', _type: 'span', marks: [], text: 'Testen vil afdække virksomhedens innovationsniveau på følgende fire områder:' }
          ],
          markDefs: [],
          style: 'normal'
        },
